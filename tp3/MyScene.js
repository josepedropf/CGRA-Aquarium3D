...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        var r_wood_alt = 0.5833;
        var g_wood_alt = 0.3733;
        var b_wood_alt = 0.0433;

        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(r_wood, g_wood, b_wood, 0);
        this.material4.setDiffuse(r_wood, g_wood, b_wood, 1.0);
        this.material4.setSpecular(r_wood, g_wood, b_wood, 0.05);
        this.material4.setShininess(0.5);
